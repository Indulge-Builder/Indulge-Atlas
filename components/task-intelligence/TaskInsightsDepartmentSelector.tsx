        ...
        {departments.map((d) => {
          ...
          return (
            <button
              ...
              className={cn(
                "inline-flex shrink-0 items-center gap-2 rounded-full border px-3 py-2 text-[13px] font-medium transition-all",
                active
                  ? "border-[#D4AF37] bg-[#FBF6E8] text-[#1A1A1A] shadow-sm"
                  : "border-[#E5E4DF] bg-white text-[#6B6B6B] hover:border-[#D0C8BE] hover:text-[#1A1A1A]",
              )}
            >
              ...
              >
                <Icon className="h-4 w-4" style={{ color: d.accentColor }} aria-hidden />
              </span>
              {d.label}
            </button>
          );
