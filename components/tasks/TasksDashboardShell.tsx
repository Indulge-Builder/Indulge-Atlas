  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F9F9F6]">
      <Tabs
        ...
        indicatorLayoutId="tasks-tab-indicator"
        animatedContent={false}
        className="flex min-h-0 flex-1 flex-col"
      >
        <div className="mx-auto w-full max-w-7xl px-6 pt-6 pb-0">
        ...
        <div className="relative mx-auto w-full max-w-7xl flex-1 overflow-hidden">
          <TabsContent value="my-tasks" className="mt-0 h-full">
            <MyTasksDashboard
          ...
          <TabsContent value="atlas-tasks" className="mt-0 h-full">
