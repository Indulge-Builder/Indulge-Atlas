...
export default async function AcademyPage({
  ...
  // Clients / Free practice / Cohort / Scenario library now live in the top
  // navigation bar (`AcademyNav`), not in a second row here.
  ...
  if (view === "ladder") {
    ...
    return (
      // The Academy shell is `h-screen` with a bounded `<main>`, so `h-full`
      // resolves to the real remaining viewport height here. The panel becomes
      // a true app frame: nothing on the page scrolls, only the message list
      // inside it does.
