-- ===========================================================================
-- ACADEMY PART 7 - curriculum structure (50-group ladder)
-- ===========================================================================
--
-- HOW TO RUN
--   Supabase dashboard -> SQL Editor -> New query.
--   Paste, then press Ctrl+A to be sure NOTHING is partially selected, Run.
--   (The editor runs only the HIGHLIGHTED text when a selection exists - a
--    half-selected string literal gives confusing 'relation ... does not
--    exist' errors that are not real missing tables.)
--
--   Run AFTER parts 1-3. Adds the Advanced/Expert difficulty tiers, the
--   group/day/task columns on scenario_seeds, and the group-progress RPC.
--   Safe to re-run.
--
--   No new tables: progress and lock state are DERIVED from an intern's own
--   training_sessions + training_reviews, so nothing needs keeping in sync.
--
-- Source: supabase/migrations/129_academy_curriculum_structure.sql
